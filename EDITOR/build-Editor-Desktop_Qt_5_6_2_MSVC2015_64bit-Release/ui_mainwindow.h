...
public:
    ...
    QDoubleSpinBox *dspDmgCooldown;
    QDoubleSpinBox *dspShootCooldown;
    QDoubleSpinBox *dspReloadTime;
    QMenuBar *menubar;
    QMenu *menu;
...
""));
        ...
        weapLoadFromFile = new QAction(MainWindow);
        weapLoadFromFile->setObjectName(QStringLiteral("weapLoadFromFile"));
        weapSaveAs = new QAction(MainWindow);
        weapSaveAs->setObjectName(QStringLiteral("weapSaveAs"));
        ...
        dspDmgCooldown = new QDoubleSpinBox(centralwidget);
        dspDmgCooldown->setObjectName(QStringLiteral("dspDmgCooldown"));
        dspDmgCooldown->setGeometry(QRect(310, 410, 62, 22));
        dspShootCooldown = new QDoubleSpinBox(centralwidget);
        dspShootCooldown->setObjectName(QStringLiteral("dspShootCooldown"));
        dspShootCooldown->setGeometry(QRect(140, 360, 62, 22));
        dspReloadTime = new QDoubleSpinBox(centralwidget);
        dspReloadTime->setObjectName(QStringLiteral("dspReloadTime"));
        dspReloadTime->setGeometry(QRect(140, 410, 62, 22));
        ...
        QWidget::setTabOrder(spinProjectileAmount, spinClipSize);
        QWidget::setTabOrder(spinClipSize, spinAmmoPerShoot);
        QWidget::setTabOrder(spinAmmoPerShoot, spinMaxScatter);
        ...
        menu->addAction(weapSaveAs);
        menu->addAction(weapLoadFromFile);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        weapNew->setShortcut(QApplication::translate("MainWindow", "Ctrl+N", 0));
        weapLoadFromFile->setText(QApplication::translate("MainWindow", "&\320\227\320\260\320\263\321\200\321\203\320\267\320\270\321\202\321\214 \320\276\321\200\321\203\320\266\320\270\320\265", 0));
        weapLoadFromFile->setShortcut(QApplication::translate("MainWindow", "Ctrl+L", 0));
        weapSaveAs->setText(QApplication::translate("MainWindow", "\320\241\320\276\321\205\321\200\320\260\320\275\320\270\321\202\321\214 &\320\272\320\260\320\272", 0));
        weapSaveAs->setShortcut(QApplication::translate("MainWindow", "Ctrl+Shift+S", 0));
